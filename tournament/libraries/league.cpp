...
int main(){
    ...
    Club mancity = Club("Man City", "MNC", 5);
    Club liverpool = Club("Liverpool", "LIV", 5);
    Club chelsea = Club("Chelsea", "CHL", 4);
    Club westham = Club("Westham", "WHU", 3);
    ...
    // premierLeague.SimulateRound();
    // premierLeague.ShowRoundResults();
    // premierLeague.RoundGameResultsForTeam("Liverpool");
    // premierLeague.ShowAllTeams();
    // premierLeague.RoundTable();
