#include <iostream>
#include <list>
#include "libraries/league.h"
#include "libraries/club.h"
...
int main(){
    ...
    Club wolverhampton = Club("Wolves", "WOL", 3);
    ...
    while(option != 7){
        ...
        cout << "3. Simulate Tournament" << endl;
        ...
        switch(option){
            ...
            case 4:
                ...
                if(roundNumber > 8 || roundNumber < 1){
                    cout << "Round number cannot be greater than 8" << endl;
                    break;
                }
